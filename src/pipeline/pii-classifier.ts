import { CanonicalUser, CanonicalOrganization, CanonicalClass } from '../types/canonical';
...
export function classifyClass(cls: CanonicalClass): CanonicalClass { return cls; }
